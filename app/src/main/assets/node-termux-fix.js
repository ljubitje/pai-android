...
// Android apps can't read /etc/resolv.conf — set DNS servers for dns.resolve*()
// calls (c-ares). The default dns.lookup() uses getaddrinfo which works on Android
// via the netd daemon, so we don't override it.
try {
